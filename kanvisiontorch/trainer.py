...
# from convs import KANConv2DLayer, KALNConv2DLayer, FastKANConv2DLayer, KACNConv2DLayer, KAGNConv2DLayer, \
    # WavKANConv2DLayer, BottleNeckKAGNConv2DLayer, MoEBottleNeckKAGNConv2DLayer
from convs import KANClassification, ConvKANLayer
from kan import KAN
...
def train_model(model, dataset_train, dataset_val, loss_func, cfg, dataset_test=None, cam_reporter=None):
    ...
    for module in model.modules():
        ...
        if isinstance(module, (ConvKANLayer, KAN)):
